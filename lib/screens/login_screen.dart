...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final imgLogo = Positioned(
      top: 150,
      child: Image.asset('assets/zelda_button_logo.jpg', height: 150,),
    );
    ...
    final imgBtn = Positioned(
      ...
      child: Transform(
        ...
        child: GestureDetector(
          ...
          child: Image.asset('assets/zelda_button_logo.jpg', height: 90,)
        )
      ),
    );
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          image: DecorationImage(
            //opacity: .5,
            fit: BoxFit.cover,
            image: AssetImage('assets/zeldaoot1.jpg')
          )
        ),
        child: Stack(
